  ...
  return (
    ...
    <main id="body" className="body w-full">
        ...
        <section  className="services w-[90%] mx-auto mt-[10rem]  rounded-2xl py-5">
          ...
          <div className="services-boxes w-[90%] mx-auto mt-5 flex flex-col items-center  border-y-[1px] border-[#B0B0B0] py-5">
            <motion.div initial={{opacity: 0}}  whileInView={{opacity :1}} className="service-box w-full flex flex-col lg:flex-row lg:items-center  lg:justify-between  border-b-[1px] py-5 border-[#B0B0B0]">
              ...
              <p className="font-[raleway] lg:w-[50%] text-[16px] sm:text-[20px] md:text-[24px] mt-2">I build dynamically, user-friendly websites that deliver a seamless experience, Mobile or Web.</p>
            </motion.div>
            <div className="service-box w-full flex flex-col lg:flex-row lg:items-center  lg:justify-between border-y-[1px] mt-2 py-5 border-[#B0B0B0]">
              ...
              <p className="font-[raleway] lg:w-[50%] text-[16px] sm:text-[20px] md:text-[24px] mt-2">Server side, Relational Databases, I'm your man. I build APIs and manage databases with ease.</p>
            </div>
            <div className="service-box w-full flex flex-col lg:flex-row lg:items-center  lg:justify-between border-t-[1px] mt-2 py-5 border-[#B0B0B0]">
              ...
              <p className="font-[raleway] lg:w-[50%] text-[16px] sm:text-[20px] md:text-[24px] mt-2">I build software to improve businesses and automate tasks. Using machine learning models to work on structured and unstructured data.</p>
            </div>
          </div>
        ...
        <section className="career w-[90%] mx-auto mt-40 mb-40 flex flex-col lg:flex-row  justify-between">
          <h1 data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000" data-aos-mirror="true" data-aos-once="false" className="font-[raleway] text-[40px] sm:text-[44px] md:text-[44px] lg:text-[48px] font-bold">Career</h1>
          <div data-aos="fade-left" data-aos-delay="50" data-aos-duration="1000" data-aos-mirror="true" data-aos-once="false" className="career-box w-[full] lg:w-[60%] mt-5 lg:mt-0 border-b-[1px] border-[#B0B0B0] py-5">
